...
**
CD "\ebjxc\"
SET PATH TO ;DATA;INCLUDE;FORMS;GRAPHICS;HELP;LIBS;MENUS;PROGS;REPORTS;BMP;BMPS;EXCEL
**

PUSH MENU _msysmenu
lcLastSetClassLib=SET("CLASSLIB")
lcMainClassLib="libs\ebjxc"
SET CLASSLIB TO (lcMainClassLib) ADDITIVE
lcOnShutdown="ShutDown()"
ON SHUTDOWN &lcOnShutdown
ON ERROR ErrorHandler(ERROR(),PROGRAM(),LINENO())
_shell="DO Cleanup IN progs\ebjxc"
...
*****
goApp.SetCaption(c公司+"   系统日期： "+trim(c系统日期)+"   操作员： "+c姓名)
*****
goApp.cStartupMenu="menus\ebjxc"
goApp.cStartupForm=""
